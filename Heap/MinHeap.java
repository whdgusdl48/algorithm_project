public class MinHeap {
    ...
    public MinHeap(){
        this.setCapacity(MinHeap.DEFAULT_CAPACITY);
        this.setHeap(new int[this.capacity()+ 1]);
        this.setSize(0);
    }
    ...
    public boolean add(int anElement){
        if(this.isFull()){
            ...
            while((i>MinHeap.Root) && (anElement < this.heap()[i/2])) {
